...
<div class="row form-group">
    <div class="col-sm-5">
        ...
        <input type="text" name="descricao" class="form-control form-control-user" id="descricao_servico" value="{{isset($registros->descricao) ? $registros->descricao : '' }}"  onChange="javascript:this.value=this.value.toUpperCase();"  required>
    ...
    <div class="col-sm-5">
        ...
        <select name="unidade" id="unidade_servico" class="form-control form-control">
...
<div class="row form-group">
    <div class="col-sm-5">
        <label for="" class="label">Preço do Serviço: </label>
        <input type="number" name="preco" class="form-control form-control-user" id="preco_servico" value="{{isset($registros->preco)? $registros->preco : '' }}" required>
    </div>
    <div class="col-sm-5">
        <label for="" class="label">Status: </label>

        <input type="checkbox" name="ativo" class="form-control form-control-user" id="ativo_servico" {{isset($registros->ativo) && $registros->ativo == 1 ? 'checked' : ''}} value="true" >
    </div>
</div>
